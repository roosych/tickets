            ...
            if (l && (!0 !== e.rendered || !l.classList.contains("initialized"))) {
                var r = parseInt(KTUtil.css(l, "height")),
                    ...
                    i = {
                        ...
                        plotOptions: {
                            radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: KTUtil.getCssVariableValue("--bs-primary-light"), strokeWidth: "100%" } },
                        },
                        colors: [o],
            ...
            if (l && (!0 !== e.rendered || !l.classList.contains("initialized"))) {
                var r = parseInt(KTUtil.css(l, "height")),
                    ...
                    i = {
                        series: [a],
                        chart: { fontFamily: "inherit", height: r, type: "radialBar", sparkline: { enabled: !0 } },
                        plotOptions: { radialBar: { hollow: { margin: 0, size: "45%" }, dataLabels: { showOn: "always", name: { show: !1 }, value: { show: !1 } }, track: { background: KTUtil.getCssVariableValue("--bs-white"), strokeWidth: "100%" } } },
                        colors: [o],
                        stroke: { lineCap: "round" },
                        labels: ["Progress"],
                    };
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            var m = i.series.push(am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "malePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-success")), clustered: !1 }));
                            m.columns.template.setAll({ tooltipText: "Males, age {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0 }),
                                m.data.setAll(a);
                            var c = i.series.push(am5xy.ColumnSeries.new(t, { name: "Males", xAxis: d, yAxis: s, valueXField: "femalePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), clustered: !1 }));
                            c.columns.template.setAll({ tooltipText: "Males, age {categoryY}: {female} ({femalePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0 }),
                                c.data.setAll(a),
                    ...
                    (() => {
                        ...
                        var a = Date.now(),
                            ...
                            o = new vis.DataSet([
                                ...
                                { id: 4, group: 4, start: moment(a).add(10, "days"), end: moment(a).add(21, "days"), content: "Deployment", progress: "74%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"] },
                            ]),
                            i = {
                                zoomable: !1,
                                moveable: !1,
                    ...
                    (() => {
                        ...
                        var a = Date.now(),
                            ...
                            o = new vis.DataSet([
                                ...
                                { id: 4, group: "dev", start: moment(a).add(4, "months"), end: moment(a).add(7, "months"), content: "Plugins", progress: "58%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"] },
                            ]),
                            i = {
                                zoomable: !1,
                                moveable: !1,
            ...
            (() => {
                ...
                var a = Date.now(),
                    ...
                    o = new vis.DataSet([
                        ...
                        { id: 4, group: "dev", start: moment(a).add(1.5, "hours"), end: moment(a).add(3, "hours"), content: "Products module", progress: "75%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"] },
                    ]),
                    i = {
                        zoomable: !1,
                        moveable: !1,
    ...
    init: function () {
        ...
        KTUtil.on(e, '[data-kt-element="checkbox"]', "change", function (e) {
            ...
            !0 === this.checked
                ...
                : (t.classList.remove("form-check-success"), l.classList.remove("bg-success"), l.classList.add("bg-primary"), (r.innerText = "In Process"), r.classList.remove("badge-light-success"), r.classList.add("badge-light-primary"));
        });
    },
};
                    ...
                    (() => {
                        ...
                        var a = Date.now(),
                            ...
                            o = new vis.DataSet([
                                ...
                                { id: 4, group: "dev", start: moment(a).add(4, "months"), end: moment(a).add(7, "months"), content: "Plugins", progress: "348%", color: "info", users: ["avatars/300-3.jpg", "avatars/300-11.jpg", "avatars/300-13.jpg"] },
                            ]),
                            i = {
                                zoomable: !1,
                                moveable: !1,
