...
return [
    ...
    'actions' => [
        ...
        'viewed' => 'Просмотр тикета',
        'update_deadline' => 'Дедлайн изменен',
    ],
    'table' => [
        'search' => 'Поиск...',
        'ticket' => 'Тикет',
    ...
    'create_modal' => [
        ...
        'private_title' => 'Приватность',
        'private_text' => 'Тикет будет доступен только менеджеру отдела.',
        'deadline_label' => 'Дедлайн',
        'pick_date' => 'Укажите дату',
    ],
    'cancel_modal' => [
    ...
    'has_deadline' => 'Дедлайн указан',
    'raiting_title' => 'Оцените тикет — это поможет улучшить работу команды.',
    'deadline_expired' => 'Дедлайн просрочен',
    'deadline_after' => 'Дедлайн через',
    'deadline_change_link' => 'Изменить',
    'deadline_modal_title' => 'Перенести дедлайн',
    'time_units' => [
        'day' => 'день|дня|дней',
        'hour' => 'час|часа|часов',
    ],
    'validations' => [
        ...
        'comment' => [
            ...
            'text_min' => 'Слишком короткий комментарий',
            'raiting' => 'Оцените выполнение тикета',
            'comment_empty' => 'Введите текст или прикрепите файл',
        ],
        'deadline' => [
            'required' => 'Укажите дату выполнения',
            'date' => 'Введите корректную дату',
            'after_or_equal' => 'Новая дата не может быть раньше текущего дедлайна.',
        ],
