    ...
    <div class="modal-dialog modal-dialog-centered mw-850px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold">{{trans('common.roles.add_role')}}</h2>
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_add_role_scroll" data-kt-scroll-offset="300px">
                        <div class="row">
                            <label class="fs-5 fw-bold form-label mb-2">
                                <span class="required">{{trans('common.roles.title')}}</span>
                            </label>
                            <div class="fv-row mb-10">
                                <input class="form-control" placeholder="{{trans('common.roles.title')}}" name="name" autocomplete="false"/>
                            </div>
                        </div>
                        <div class="fv-row">
                            <label class="fs-5 fw-bold form-label mb-2">
                                {{trans('common.roles.permissions')}}
                            </label>
