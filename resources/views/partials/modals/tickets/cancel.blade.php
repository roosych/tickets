    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold">
                    {{trans('tickets.cancel_modal.title')}}
                </h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="cancel_ticket_form" class="form">
                    ...
                    <div class="fv-row">
                        ...
                        <textarea class="form-control form-control-solid mb-4" rows="4" placeholder="{{trans('tickets.cancel_modal.comment_placeholder')}}" name="cancelled_comment"></textarea>
                    </div>
